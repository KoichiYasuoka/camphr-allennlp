...
from camphr_allennlp.common.lazy import Lazy
...
def is_base_registrable(cls) -> bool:
    ...
    a class.
    """
    from camphr_allennlp.common.registrable import Registrable  # import here to avoid circular imports
...
def pop_and_construct_arg(
    ...
    """
    from camphr_allennlp.models.archival import load_archive  # import here to avoid circular imports
