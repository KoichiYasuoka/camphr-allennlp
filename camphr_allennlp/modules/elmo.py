...
from camphr_allennlp.common import FromParams
from camphr_allennlp.common.checks import ConfigurationError
from camphr_allennlp.common.file_utils import cached_path
from camphr_allennlp.common.util import lazy_groups_of
from camphr_allennlp.data import Instance, Token, Vocabulary
from camphr_allennlp.data.batch import Batch
from camphr_allennlp.data.fields import TextField
from camphr_allennlp.data.token_indexers.elmo_indexer import (
    ELMoCharacterMapper,
    ELMoTokenCharactersIndexer,
)
from camphr_allennlp.modules.elmo_lstm import ElmoLstm
from camphr_allennlp.modules.highway import Highway
from camphr_allennlp.modules.scalar_mix import ScalarMix
from camphr_allennlp.nn.util import (
...
class _ElmoBiLm(torch.nn.Module):
    ...
    def create_cached_cnn_embeddings(self, tokens: List[str]) -> None:
        ...
        from camphr_allennlp.modules.token_embedders import Embedding  # type: ignore
