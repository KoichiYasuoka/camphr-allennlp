...
def find_text_field_embedder(model: torch.nn.Module) -> torch.nn.Module:
    ...
    """
    from camphr_allennlp.modules.text_field_embedders.text_field_embedder import TextFieldEmbedder
...
def find_embedding_layer(model: torch.nn.Module) -> torch.nn.Module:
    ...
    from camphr_allennlp.modules.text_field_embedders.text_field_embedder import TextFieldEmbedder
    from camphr_allennlp.modules.text_field_embedders.basic_text_field_embedder import (
